...
const locations = [
    {
        ...
        builtData: 1909,
        description: "The viewfinders found on Makapu’u Point in O’ahu, Hawaii offer unparalleled views into the Pacific Ocean, yet their location on Makapu’u - the easternmost point of the island - can also provide a look into the island’s past.",
        coordinates: [11.83721, 48.27761],
        wesAndersonMovie: "The Darjeeling Limited"
    },
    {
        owner: "User1",
        ...
        builtData: 1896,
        description: "As a central place in Budapest’s arts and cultural scene, the Hotel Nemzeti itself can be considered a work of art. Built in 1896 and located near the city’s famed National Theater, the Nemzeti has hosted both travelers and influential cultural figures throughout the last 100 years.",
        coordinates: [0.75458, 43.01551],
        wesAndersonMovie: "The Grand Budapest Hotel"
    },
    {
        owner: "User1",
    ...
    },
    {
        ...
        builtDate: 1888,
        description: "As rail travel exploded across Canada during the late 19th century, the Canadian Pacific Railway sought to provide their passengers places to stay during their scenic tours.Soon, grand, stately Chatauesque hotels started popping up throughout the country, including the Banff Springs Hotel in Alberta.",
    ...
    },
    {
        ...
        description: "Just north of Whistler, British Columbia, within the Marriott Basin, a two - story wooden hut with a pronounced Gothic arch sits among the mountains and Alpine meadows.Maintained by the Alpine Club of Canada, the Wendy Thompson Hut was created to preserve the memory of a beloved Whistler resident.",
        coordinates: [-122.81626, 53.85158],
        wesAndersonMovie: "Rushmore"
    },
    {
        owner: "Someowner",
    ...
    },
    {
        ...
        description: "The Southern Fuegian Railway, also referred to as El Tren del Fin del Mundo - or The Train of the End of the World - in its native Argentina, is more enduring in origin than it is apocalyptic.Its name actually refers to its locale as the southernmost railway in the world.",
    ...
    },
    {
        ...
        description: "Just like the ever - changing field of medicine, the Hospital De Sant Pau has evolved over the centuries.The institution's beginnings are rooted in the medieval tradition and date back to 1401 when six Barcelona hospitals merged into one, creating the ​Hospital de la Santa Creu.",
    ...
    },
    {
        ...
        builtData: 1897,
        located: "Budapest, Hungary",
        description: "Beneath a roof of colorful iridescent tiles, the Great Market Hall in Budapest - also called the Central Market Hall - welcomes patrons looking for fresh produce, dairy, meats, and a wealth of local Hungarian goods and souvenirs.Comprised of three floors, the Market is lauded for both its size and architectural significance within the city.The Market came into fruition by way of Budapest’s first mayor, Károly Kamermayer, who made its construction his greatest investment during his tenure.Talks of a market hall in the city had been going on for decades, but elected officials struggled to make progress.",
    ...
    },
    {
        ...
        description: "Along the land that encloses North San Diego Bay in California, an unassuming structure sits watch over the Pacific, the Old Point Loma Lighthouse.According to local lore, the lighthouse and the land are named after a young Russian girl who survived a shipwreck and wandered ashore.",
    ...
    },
    {
        ...
        builtData: 1724,
        located: "Delhi, India",
        description: "With foreign invasions and internal unrest, India in the 18th century had to endure one of the most chaotic periods in its entire history.Still, one man remained focused on the stars.Maharaja Sawaii Jai Singh II was a kingdom ruler with great interest in astronomy.Along with his political contributions, his legacy endures through the Jantar Mantar.",
